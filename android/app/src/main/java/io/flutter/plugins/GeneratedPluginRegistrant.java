...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new tech.thispage.widgets_easier.WidgetsEasierPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin widgets_easier, tech.thispage.widgets_easier.WidgetsEasierPlugin", e);
    }
  }
}
